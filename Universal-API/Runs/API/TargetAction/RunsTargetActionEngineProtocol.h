...
typedef NS_ENUM(NSUInteger, RunsControlEvents) {
    ...
    RunsControlEvent_DeleteAll              = 27,
    RunsControlEvent_SelectAll              = 28,
    RunsControlEvent_SelectNone             = 29,
...
- (void)removeTarget:(id)target action:(SEL)action forControlEvents:(RunsControlEvents)controlEvents;
- (void)clear;
@optional
