...
/**
 普通 GET 请求 在指定线程 请求结束默认不抛回主线程执行 回调

 @param URLString 完整的URL
 @param parameters 请求参数 比如字典
 @param operationQueue queue
 @param success 成功回调
 @param failure 失败回调
 @return 实例
 */
- (NSURLSessionDataTask * _Nullable)GET:(NSString *)URLString
                             parameters:(NSDictionary* _Nullable)parameters
                                  queue:(NSOperationQueue * _Nullable)operationQueue
                                success:(SessionDataTaskSuccessCallback _Nullable)success
                                failure:(SessionDataTaskFailureCallback _Nullable)failure;

/**
 普通 POST 请求 json 请求结束默认抛回主线程执行 回调
...
- (NSURLSessionDataTask *)POST:(NSString *)URLString
                          json:(NSDictionary *)parameters
                       success:(SessionDataTaskSuccessCallback)success
                       failure:(SessionDataTaskFailureCallback)failure;

/**
 普通 POST 请求 json 请求结束默认不抛回主线程执行 回调
...
- (NSURLSessionDataTask *)POST:(NSString *)URLString
                       ...
                       failure:(SessionDataTaskFailureCallback)failure;
/**
 普通 POST 请求 表单 请求结束默认抛回主线程执行 回调
...
/**
 普通 POST 请求 表单 请求结束默认不抛回主线程执行 回调
