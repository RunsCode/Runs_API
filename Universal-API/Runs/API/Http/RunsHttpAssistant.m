...
- (BOOL)canRetryRequest {
    ...
    switch (_method) {
        ...
        case HttpMethod_Post:
            ...
            break;
        case HttpMethod_Post_Json:
            [RunsHttpSessionProxy.sharedInstance POST:_urlString json:_parameters success:_success failure:_failure];
            break;
        ...
        case HttpMethod_Head:
            [RunsHttpSessionProxy.sharedInstance HEAD:_urlString parameters:_parameters success:_success failure:_failure];
            break;
